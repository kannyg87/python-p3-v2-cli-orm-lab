...
def create_employee():
    ...
    try:
        ...
        print("Invalid department ID. Please enter a valid number.")
    except Exception as exc:
...
def list_department_employees():
    ...
    employees = Employee.find_by_id_all(department_id)
    print(employees) if employees else print(f'No employees found in department {department_id}')
